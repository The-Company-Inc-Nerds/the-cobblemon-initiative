...
execute as @a[scores={granary_ambush_armed=300..}] unless entity @s[tag=defeated_granary_ambush] run tbcs battle GEN_9_SINGLES @s vs rctmod:granary_ambush onwin {1: ['cobbledollars give @1 600', 'tag @1 add defeated_granary_ambush'], 2: []}
