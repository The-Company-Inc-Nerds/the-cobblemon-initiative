# East Market Street — Madam Qiu, the mint apothecary: Careful Mint (2200 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:careful_mint 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Careful Mint. ","color":"green"},{"text":"-2200 CD","color":"gray"}]
