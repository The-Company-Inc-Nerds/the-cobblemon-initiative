...
execute if score #amb_villain_site_manager ci_ambient matches 0 if entity @a[x=1585.5,y=88,z=2480.5,distance=..40] run function cobblemon_initiative:ambient/place/villain_site_manager
...
execute if score #amb_villain_yield_officer ci_ambient matches 0 if entity @a[x=1579.5,y=88,z=2459.5,distance=..40] run function cobblemon_initiative:ambient/place/villain_yield_officer
