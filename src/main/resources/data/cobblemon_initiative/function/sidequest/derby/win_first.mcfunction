# Sango Classic — first win: 500 CD (skew-aware), 2 poke balls, 5 oran berries, champion latch.
...
tellraw @s [{"text":"First place in the Sango Classic. Purse: 500 CD, two Poke Balls, five oran berries.","color":"aqua"}]
