...
execute if score #var_takehara_trainer_3 ci_ambient matches 1 run easy_npc preset import_new data easy_npc:preset/humanoid/takehara_trainer_3.npc.snbt 2055.3 151 2428.6
execute if score #var_takehara_trainer_3 ci_ambient matches 2 run easy_npc preset import_new data easy_npc:preset/humanoid/takehara_trainer_3_b.npc.snbt 2055.3 151 2428.6
