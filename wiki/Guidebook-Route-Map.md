...
```mermaid
flowchart TD
  S["Sango Town — start<br/>cap 15"] --> G1["1. Takehara Falls — Bug<br/>~1910, 109, 2524 · cap 22"]
  G1 --> G2["2. Hua Zhan City — Grass<br/>~1500, 86, 2053 · cap 30"]
  G2 --> G3["3. Mystic Marsh — Fairy<br/>~1073, 65, 2441 · cap 37"]
  G3 --> G4["4. Deepcore City — Fighting<br/>~1045, 129, 3186 · cap 44"]
  G4 --> G5["5. Gaviota Port — Water<br/>~624, 82, 3536 · cap 50"]
  G5 --> G6["6. Kalahar Reach — Ground<br/>~2085, 126, 4050 · cap 56"]
  G6 --> G7["7. Cyber City — Electric<br/>~1462, 89, 1185 · cap 62"]
  G7 --> HQ["HQ Raid — Acting CEO DJ<br/>1590, 51, 1028 · CURRENCY STABILIZED"]
  HQ --> G8["8. Ryujin Keep — Dragon<br/>~2156, 201, 884 · cap 68"]
  G8 --> G9["9. Nifl Town — Ice<br/>~3608, 112, 2031 · cap 74"]
  G9 --> G10["10. Scorchspire — Fire<br/>~3700, 100, 4511 · cap 80"]
  ...
  RL -. "post-Champion" .-> SR["Fire Shrine (Trial by Flame)"]
```
...
8. **→ Ryujin Keep.** Beat **Leader Ryujin** (Dragon). **Optional:** the **Dragon Shrine — Hydra Gauntlet** (three battles, full heal between — the safest shrine). → cap **68**. *Act III —* see [[Guidebook Act III]]. *The road here is watched:* the **7→8** run is lined with **line-of-sight trainers** — battlers who spot you on approach and lock you into a fight the moment you cross their eyeline.
9. **→ Nifl Town.** Beat **Leader Boreas** (Ice). **Optional:** the **Ice Shrine — Frozen Path** (timed parkour, 180s — now with an ice-floor hazard off the safe path). → cap **74**. *More eyes on the road:* the **8→9** leg is also patrolled by **line-of-sight trainers**.
10. **→ Scorchspire.** Climb the **Victory Road** (the **9→10** run) — a corridor of **line-of-sight trainers** — then the **Cinderfall Descent** into the crater, and beat **Leader Vulcan** (Fire), the final gym. → cap **80**. *(The Fire Shrine is **not** the Scorchspire detour — its cult only answers to a Champion; see step 11.)* **Endgame twist:** the **four Cinderfall Descent trainers re-trigger** once you've earned the **10th badge** — the descent becomes a re-battleable **fire gauntlet** on the way back out.
...
- **The late roads watch you.** From gym 7 onward the routes are lined with **line-of-sight trainers** — the **7→8** and **8→9** legs, the **Victory Road** (9→10), and the **Cinderfall Descent**. They **spot you and battle** the moment you cross their eyeline, so mind your team's health between towns. The **four Cinderfall Descent trainers re-trigger** after the 10th badge — an endgame fire gauntlet you can re-run.
