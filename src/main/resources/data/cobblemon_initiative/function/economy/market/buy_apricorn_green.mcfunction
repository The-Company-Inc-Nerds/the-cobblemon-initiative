# East Market Street — Bo Huan, the apricorn cart: Green Apricorns x2 (120 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:green_apricorn 2
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Green Apricorns x2. ","color":"green"},{"text":"-120 CD","color":"gray"}]
