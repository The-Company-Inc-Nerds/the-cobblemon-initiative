...
# advances the arc scoreboard out loud (n of 6).
title @s times 10 70 20
$execute if score @s fields_liberated matches 2.. run title @s subtitle [{"text":"The commodity loses ground — $(n) of 6","color":"gray"}]
