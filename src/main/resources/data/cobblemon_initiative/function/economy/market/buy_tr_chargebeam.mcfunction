# Takehara Falls machine counter — Machine Counter Mika (badge-1 TR page): TR Charge Beam (1000 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s simpletms:tr_chargebeam 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased TR Charge Beam. ","color":"green"},{"text":"-1000 CD","color":"gray"}]
