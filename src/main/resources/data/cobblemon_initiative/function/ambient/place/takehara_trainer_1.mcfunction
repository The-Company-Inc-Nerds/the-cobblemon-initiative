...
execute if score #var_takehara_trainer_1 ci_ambient matches 1 run easy_npc preset import_new data easy_npc:preset/humanoid/takehara_trainer_1.npc.snbt 2055.5 138 2502.6
execute if score #var_takehara_trainer_1 ci_ambient matches 2 run easy_npc preset import_new data easy_npc:preset/humanoid/takehara_trainer_1_b.npc.snbt 2055.5 138 2502.6
