# Skewed CobbleDollar payout, COMPANY-BRANDED receipt. Run as the receiving player:
#   execute as <player> run function cobblemon_initiative:economy/payout_company {amount:N}
# Same math as economy/payout; only the actionbar letterhead differs (see pay_macro_company).
...
function cobblemon_initiative:economy/pay_macro_company with storage cobblemon_initiative:economy
