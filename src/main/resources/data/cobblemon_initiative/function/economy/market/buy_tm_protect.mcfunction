# Takehara Falls machine counter — Machine Counter Mika (badge-2 TM page): TM Protect (3000 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s simpletms:tm_protect 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased TM Protect. ","color":"green"},{"text":"-3000 CD","color":"gray"}]
