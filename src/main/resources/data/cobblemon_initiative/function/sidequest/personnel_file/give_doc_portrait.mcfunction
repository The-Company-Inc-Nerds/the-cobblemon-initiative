...
# prop). Run as the player by docprop.DocPropManager when the portrait chest (2591 111 2815)
# is clicked; the handler only fires while file_opened is set and doc_portrait is not.
