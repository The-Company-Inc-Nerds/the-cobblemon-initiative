# East Market Street — Bo Huan, the apricorn cart: Black Apricorns x2 (120 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:black_apricorn 2
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Black Apricorns x2. ","color":"green"},{"text":"-120 CD","color":"gray"}]
