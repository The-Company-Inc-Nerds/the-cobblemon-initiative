# East Market Street — Madam Qiu, the mint apothecary: Timid Mint (2200 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:timid_mint 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Timid Mint. ","color":"green"},{"text":"-2200 CD","color":"gray"}]
