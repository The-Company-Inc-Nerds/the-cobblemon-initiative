# East Market Street — Auntie Song, the berry stand: Cheri Berry x2 (90 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:cheri_berry 2
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Cheri Berry x2. ","color":"green"},{"text":"-90 CD","color":"gray"}]
