...
Built for the **UPM Custom Map** by [Varuna Studios](https://varunastudios.com) — a hand-crafted open world with distinct biome regions, purpose-built towns, and a continuous overworld adventure loop.
...
| Shrine | Coordinates | Entry Requirement | High Priest |
|--------|-------------|-------------------|-------------|
| Fairy Shrine | 947 -7 2715 | Mystic Marsh cleared | High Priest Mab |
| Ground Shrine | 1899 83 4049 | Kalahar Reach cleared | High Priest Terran |
| Dragon Shrine | 1998 66 921 | Ryujin Keep cleared | High Priest Draconis |
| Ice Shrine | 3634 68 1960 | Nifl Town cleared | High Priest Boreal |
| Fire Shrine | 3500 51 4702 | Royal League cleared | High Priest Ignis |
...
The antagonist organization operating throughout the region. Their stated goal: destabilize the emerald-based currency system (which they helped design) and replace it with a wheat-backed commodity economy that they monopolize through total agricultural control.
...
| Acting CEO | Midas | After Noir |
| The Founder | ??? | After Midas + Royal League (Final Boss) |

Their base of operations is at **Team Rocket Base — 1590 51 1028**.
...
### Varuna Studios — UPM Custom Map

The world that The Cobblemon Initiative is built for was created by **Varuna Studios**. Their **UPM (Universal Pokémon Map)** is a hand-crafted, purpose-built Minecraft world featuring:
