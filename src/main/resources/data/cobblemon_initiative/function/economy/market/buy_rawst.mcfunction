# East Market Street — Auntie Song, the berry stand: Rawst Berry x2 (90 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:rawst_berry 2
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Rawst Berry x2. ","color":"green"},{"text":"-90 CD","color":"gray"}]
