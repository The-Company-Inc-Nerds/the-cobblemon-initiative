...
execute if score #kele_roll ci_item matches 1 run givepokemonother @s eevee level=5 shiny=true
...
execute unless score #kele_roll ci_item matches 1 run givepokemonother @s eevee level=5
