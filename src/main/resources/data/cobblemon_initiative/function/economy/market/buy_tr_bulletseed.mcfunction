# Sango Town back lane — Torn-Label Tadashi, the TR peddler: TR Bullet Seed (800 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s simpletms:tr_bulletseed 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased TR Bullet Seed. ","color":"green"},{"text":"-800 CD","color":"gray"}]
