...
tellraw @s [{"text":"Insured parcel rate paid: ","color":"gray"},{"text":"500 CD, two candies, one Heal Ball. ","color":"gold"},{"text":"Mio will want a rematch every morning.","color":"dark_gray","italic":true}]
