...
public class DeathMechanicsInit implements ModInitializer {
  ...
  public void onInitialize() {
    ...
    CobblemonEvents.BATTLE_FAINTED.subscribe(
      Priority.NORMAL,
      DeathMechanicsInit::handleBattleFainted
    );
    CobblemonEvents.BATTLE_FLED.subscribe(
      Priority.NORMAL,
      DeathMechanicsInit::handleBattleFled
    );
    CobblemonEvents.BATTLE_VICTORY.subscribe(
      Priority.NORMAL,
      DeathMechanicsInit::handleBattleVictory
    );
    CobblemonEvents.POKEMON_CAPTURED.subscribe(
      Priority.NORMAL,
      DeathMechanicsInit::handlePokemonCaptured
    );
    ...
    for (BattleActor loser : event.getLosers()) {
      ...
      if (remainingPokemon > 0) {
        ...
        if (remainingPokemon == 1) {
          ...
          DeathMechanicsClientInit.triggerSacrificeSelection();
        }
      }
    }
