# Deepcore Dust Ward signal cabinet — Helka Dustmantle: Hopper (300 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s minecraft:hopper 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Hopper. ","color":"green"},{"text":"-300 CD","color":"gray"}]
