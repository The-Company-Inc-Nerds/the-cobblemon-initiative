...
- [ ] **P5 — Wheat traders full wiring** — _done: the trade→recognize→ambush dialogue, `minecraft:paper` currency, and 2/4 recognition/ambush thresholds._ Remaining: in-world placement (Easy NPC traders) + the post-trade ambush trigger. (Wheat→CobbleDollars is the built-in bank; no custom Granary/`sell_wheat` — confirmed.)
