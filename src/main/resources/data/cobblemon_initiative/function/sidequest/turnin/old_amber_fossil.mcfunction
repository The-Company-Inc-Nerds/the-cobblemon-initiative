...
# 2313.8; the fossil floats at +1 = 1902.5/116/2313.8). Run AS THE PLAYER from the revive_aerodactyl dialog
# button (gated not_tag sq_revived_aerodactyl - per-species, so each dug fossil revives once). Consume-probe
