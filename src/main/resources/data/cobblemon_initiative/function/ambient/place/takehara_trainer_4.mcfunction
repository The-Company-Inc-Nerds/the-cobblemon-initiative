...
execute if score #var_takehara_trainer_4 ci_ambient matches 1 run easy_npc preset import_new data easy_npc:preset/humanoid/takehara_trainer_4.npc.snbt 2055.3 138 2428.6
execute if score #var_takehara_trainer_4 ci_ambient matches 2 run easy_npc preset import_new data easy_npc:preset/humanoid/takehara_trainer_4_b.npc.snbt 2055.3 138 2428.6
