# Sango Town back lane — Torn-Label Tadashi, the TR peddler: TR Rock Tomb (1000 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s simpletms:tr_rocktomb 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased TR Rock Tomb. ","color":"green"},{"text":"-1000 CD","color":"gray"}]
