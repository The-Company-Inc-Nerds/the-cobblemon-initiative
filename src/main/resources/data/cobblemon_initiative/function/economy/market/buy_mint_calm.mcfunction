# East Market Street — Madam Qiu, the mint apothecary: Calm Mint (2200 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:calm_mint 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Calm Mint. ","color":"green"},{"text":"-2200 CD","color":"gray"}]
