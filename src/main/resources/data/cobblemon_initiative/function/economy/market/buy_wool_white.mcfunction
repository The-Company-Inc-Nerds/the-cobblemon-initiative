# East Market house counter — Kaito Zhang, the wool shelf: White Wool x8 (120 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s minecraft:white_wool 8
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased White Wool x8. ","color":"green"},{"text":"-120 CD","color":"gray"}]
