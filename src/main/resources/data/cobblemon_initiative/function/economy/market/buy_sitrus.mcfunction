# East Market Street — Auntie Song, the berry stand: Sitrus Berry (150 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:sitrus_berry 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Sitrus Berry. ","color":"green"},{"text":"-150 CD","color":"gray"}]
