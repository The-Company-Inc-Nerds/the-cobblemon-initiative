...
| **Board hunt** | champion (late, terminal) | late | the First Seat proud; the Third Seat doubles down; the Second Seat stands down intellectually; the Fourth Seat emotionally. Pointer civilians none — except Odei (liberated-field keeper) gets the wary *face on a memo* beat, never learns who. | ✅ terminal gradient; the one allowed wary-keeper beat is correctly scoped |
