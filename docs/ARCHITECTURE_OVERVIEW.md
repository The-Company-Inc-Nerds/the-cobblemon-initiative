...
For the actual event-driven workflows (battle victory, faint, NPC sight, economy, quest tracking), see [Architecture Data Flows](ARCHITECTURE_DATA_FLOWS.md). For the full command surface, see [Commands](https://github.com/The-Company-Inc-Nerds/the-cobblemon-initiative/wiki/Commands). To get oriented, start at [Home](https://github.com/The-Company-Inc-Nerds/the-cobblemon-initiative/wiki/Home).
...
- **[Architecture Data Flows](ARCHITECTURE_DATA_FLOWS.md)** — the event-driven workflows in detail: battle victory → badge progression, faint → death screen, NPC sight raycast, the Wheat War economy, the Quest HUD, the quest tracker, the loot-chest roll, and the shrine challenge engine.
- **[Commands](https://github.com/The-Company-Inc-Nerds/the-cobblemon-initiative/wiki/Commands)** — the complete command reference, permission levels, and dev-tool tree.
- **[Home](https://github.com/The-Company-Inc-Nerds/the-cobblemon-initiative/wiki/Home)** — project overview and the campaign guidebook entry points.