...
The Company's showroom city — neon, exchange boards, and a currency that has never felt this fake.
...
## Gym 7 — The Electric Gym (Electric Badge ⚡)

> **Leader Volt** · downtown arena at `[1462 89 1185]` · **cap → 62** · **memory fragment 7**
...
| Rung | Who | Team |
|------|-----|------|
| Guitarist Amp | trainer_1 | Pikachu 50, Voltorb 51 |
| Engineer Watt | trainer_2 | Magnemite 51, Electrike 51 |
| Rocker Static | trainer_3 | Elekid 50, Pachirisu 51 |
| Mechanic Gigabyte | trainer_4 | Emolga 51, Luxio 51 |
| Jr. Apprentice Voltz | jr_apprentice | Electrode 52, Luxray 52 |
| Apprentice Surge | apprentice | Raichu 54, Magneton 54, Manectric 53 |
| **Leader Volt** | leader | **Magnezone 56, Jolteon 56, Luxray 57, Electivire 58 (ace)** |

> Ground is the classic answer and shuts down most of the room — but Magnezone (Electric/Steel) and
> Emolga/Luxray dodge a Ground-only plan. Bring coverage.

### Rewards

Standard badge packet: flat prize, **cap → 62**, and **memory fragment 7 — "You signed this
charter."** This is the **hard turn** of the whole run: the fragment that stops being a flicker and
