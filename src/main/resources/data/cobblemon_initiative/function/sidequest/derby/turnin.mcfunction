...
execute if score @s ci_classic_win matches 0 run tellraw @s [{"text":"Deka counts the bucket: ","color":"gray"},{"score":{"name":"@s","objective":"ci_fish_total"},"color":"aqua"},{"text":" of 5. Keep casting.","color":"gray"}]
