# Sango Town back lane — Torn-Label Tadashi, the TR peddler: TR Protect (1000 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s simpletms:tr_protect 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased TR Protect. ","color":"green"},{"text":"-1000 CD","color":"gray"}]
