...
# "can afford" without spending. If affordable, ring Liang's beacon-in-stock call (one-shot:
# phone/tick gates on call_beacon_stock_done, granted by the call script's done_tag on
# completion). (cd_calc declared by economy/load.)
