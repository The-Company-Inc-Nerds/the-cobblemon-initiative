# East Market Street — Madam Qiu, the mint apothecary: Bold Mint (2200 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:bold_mint 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Bold Mint. ","color":"green"},{"text":"-2200 CD","color":"gray"}]
