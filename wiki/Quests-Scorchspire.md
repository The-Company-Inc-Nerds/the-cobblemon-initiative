...
The last gym — a volcano forge where the heat is part of the fight. Beat Vulcan and the ten-badge
road is done; the Royal League is all that stands between you and the answer. The Fire Shrine (the
...
## Gym 10 — The Forge Gym (Fire Badge 🔥)

> **Leader Vulcan** · forge arena at `[3700 100 4511]` · **cap → 80** · **memory fragment 10**

**Entry cap: 74** (from the Ice Badge). Vulcan's ace sits at **76**.

### The gimmick — Banked Coals

A **heat gauge** climbs during the fight. Wardens around the arena **vent** it to cool the room —
but let the heat max out and Vulcan is forced into a **full-power** loadout. Manage the gauge (and
the wardens) and you fight a leader who is holding back; ignore it and you fight one who isn't.

### The ladder

| Rung | Who | Team |
|------|-----|------|
| Kindler Blaze | trainer_1 | Growlithe 68, Vulpix 69 |
| Fire Breather Pyra | trainer_2 | Magmar 69, Houndour 69 |
| Pyrotechnician Scorch | trainer_3 | Houndoom 68, Magmar 69 |
| Flame Dancer Cinder | trainer_4 | Ponyta 68, Ninetales 69 |
| Jr. Apprentice Ember | jr_apprentice | Magmar 69, Arcanine 70 |
| Apprentice Inferno | apprentice | Arcanine 72, Ninetales 72, Houndoom 71 |
| **Leader Vulcan** | leader | **Magmortar 74, Chandelure 74, Typhlosion 75, Charizard 76 (ace)** |

> Water, Rock, and Ground are the answers; Charizard (Fire/Flying) is 4× weak to Rock. Watch for
> Houndoom's Dark coverage on the way up.

### Rewards

Standard badge packet: flat prize, **cap → 80**, and **memory fragment 10 — "face your own
signature."** The last badge, and the last flicker before the League gives you the whole picture.
...
## The Fire Shrine — the map's best loot

On the far slope at `[3510 51 4702]`, **High Priest Ignis** guards the Fire Shrine. It's **the prize
shrine**: its leader drops a **Master Ball + a Netherite Ingot** on defeat (most shrines pay Rare
Candy + Diamonds). Optional, off-route, dangerous — see **[[Guidebook Shrines]]**.

## Where it sits on the road

With ten badges, the road opens to the **Royal League** `[3528 166 2773]` — see
**[[Guidebook Act III]]**. Gimmicks: **[[Guidebook Gym Mechanics]]**.
