...
# Called from ambient/tick, executed POSITIONED AT the groundskeeper body (tag
# aya_groundskeeper) the tick after a challenger who cleared all four garden wardens
# tags themselves aya_transformed via her dialog. Spawn Leader Blossom at her exact
# spot, flourish in bloom, then despawn the groundskeeper. Guarded upstream so this
# fires exactly once (unless entity hz_leader_body).
