# Deepcore Dust Ward signal cabinet — Helka Dustmantle: Repeater (150 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s minecraft:repeater 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Repeater. ","color":"green"},{"text":"-150 CD","color":"gray"}]
