...
The Act II climax. After the seventh badge, the main-quest line stops pointing at gyms and points at
the tower: **liberate the wheat fields, then raid Company HQ.** Winning it stabilizes the currency —
the single biggest economy payoff in the run.
...
With DJ down and the currency stable, the main line returns to the road — **gyms 8–10**, then the
**[[Quests Royal League]]**. The post-HQ towns (Ryujin, Nifl, Scorchspire) wear the
aftermath. The full arc through the ending is on **[[Guidebook Act III]]**.
