# Mystic Marsh machine counter — Ilyana Mossveil (badge-2 thread rack): TR Mud Shot (1100 CD).
# Item id jar-verified vs SimpleTMs-fabric-2.3.3 (assets/simpletms/models/item/tr_mudshot.json).
...
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased TR Mud Shot. ","color":"green"},{"text":"-1100 CD","color":"gray"}]
