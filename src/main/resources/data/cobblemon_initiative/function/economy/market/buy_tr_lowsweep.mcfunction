# Takehara Falls machine counter — Machine Counter Mika (badge-1 TR page): TR Low Sweep (1200 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s simpletms:tr_lowsweep 1
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased TR Low Sweep. ","color":"green"},{"text":"-1200 CD","color":"gray"}]
