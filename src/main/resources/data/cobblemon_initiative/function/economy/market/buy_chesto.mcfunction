# East Market Street — Auntie Song, the berry stand: Chesto Berry x2 (90 CD).
...
execute if score #market_ok cd_calc matches 1.. run give @s cobblemon:chesto_berry 2
execute if score #market_ok cd_calc matches 1.. run title @s actionbar [{"text":"Purchased Chesto Berry x2. ","color":"green"},{"text":"-90 CD","color":"gray"}]
